...
export const metadata: Metadata = {
  title: 'App Hub - La tua piattaforma di app',
  description: 'Accedi a tutte le app di cui hai bisogno in un unico posto. Gestisci menu, prenotazioni, AI chat e molto altro.',
  keywords: 'app, dashboard, menu, booking, AI, analytics, task manager, invoices',
  authors: [{ name: 'App Hub Team' }],
  viewport: 'width=device-width, initial-scale=1',
  robots: 'index, follow',
  openGraph: {
    title: 'App Hub - La tua piattaforma di app',
    description: 'Accedi a tutte le app di cui hai bisogno in un unico posto.',
    type: 'website',
    locale: 'it_IT',
  },
};
