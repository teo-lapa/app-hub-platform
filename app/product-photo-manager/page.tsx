    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h1 className="text-3xl font-bold text-white">Product Photo Manager 🍌</h1>
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3 pt-4 border-t border-slate-700">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 hover:from-purple-600 hover:via-pink-600 hover:to-orange-600 text-white font-semibold rounded-lg transition-all flex items-center justify-center gap-2 shadow-lg"
                >
      ...
      {productForAI && (
        <AIImageModal
          ...
          productId={productForAI.id}
          productName={productForAI.name}
          currentImage={productForAI.image_256}
