    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-sm p-8 max-w-md w-full text-center">
          <p className="text-red-600 mb-4">{error || 'Profilo non trovato'}</p>
          <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                ...
                {profile.vat && (
                  <div>
                    ...
                    <p className="text-gray-900 font-mono">{profile.vat}</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
              ...
              <div className="space-y-2">
                {profile.address.street && <p className="text-gray-900">{profile.address.street}</p>}
                {profile.address.street2 && <p className="text-gray-900">{profile.address.street2}</p>}
                <p className="text-gray-900">
                  {[profile.address.zip, profile.address.city].filter(Boolean).join(' ')}
                </p>
                {profile.address.state && <p className="text-gray-900">{profile.address.state}</p>}
                {profile.address.country && <p className="text-gray-700">{profile.address.country}</p>}
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-xs text-gray-500 mb-1">Limite di Credito</p>
                ...
                <div className="pt-4 border-t border-gray-100">
                  <p className="text-xs text-gray-500 mb-1">Credito Utilizzato</p>
                ...
                <div className="pt-4 border-t border-gray-100">
                  <p className="text-xs text-gray-500 mb-1">Credito Disponibile</p>
