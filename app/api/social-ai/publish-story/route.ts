...
async function createSocialPost(
  ...
  try {
    console.log(`🔄 [PUBLISH-STORY] Pubblicazione post ${postId}...`);
    await callOdoo(odooCookies, 'social.post', 'action_post', [[postId]]);
    console.log(`✅ [PUBLISH-STORY] action_post chiamato con successo`);
  } catch (e: any) {
    console.warn(`⚠️ [PUBLISH-STORY] action_post fallito:`, e.message);
  }
