...
async function createSocialPost(
  ...
  try {
    console.log(`🔄 [PUBLISH-ARTICLE] Pubblicazione post ${postId}...`);
    await callOdoo(odooCookies, 'social.post', 'action_post', [[postId]]);
    console.log(`✅ [PUBLISH-ARTICLE] action_post chiamato con successo`);
  } catch (e: any) {
    console.warn(`⚠️ [PUBLISH-ARTICLE] action_post fallito:`, e.message);
  }
