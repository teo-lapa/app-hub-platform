...
/**
 * CHAT VENDITORI - Interfaccia Chat per Venditori LAPA
 *
 * Pagina di chat full-screen per i venditori che permette di:
 * - Cercare clienti e storico ordini
 * - Controllare disponibilità prodotti
 * - Creare ordini tramite linguaggio naturale
 * - Inviare foto/audio degli ordini
 * - Supporto multimodale: immagini, PDF, audio
 */
...
export default function ChatGestionalePage() {
  ...
  const sendMessage = useCallback(async (messageText?: string) => {
    ...
    try {
      ...
      const response = await fetch('/api/chat-venditori', {
        method: 'POST',
        body: formData,
